...
/* DSblock model generated by Dymola from Modelica model Hydro_Power_My_Work.Tut_4.ElectricKettle
 Dymola Version 2020 (64-bit), 2019-04-10 translated this at Wed Nov  3 22:55:29 2021
...
#define NHash1_ 650341310
#define NHash2_ -698557817
#define NHash3_ 0
#define NI_    0
#define NRelF_ 3
#define NRel_  3
...
PreNonAliasDef(5)
#if !defined(DYM2CCUR)
 DYMOLA_STATIC const char*modelName="Hydro_Power_My_Work.Tut_4.ElectricKettle";
#endif
...
DeclareVariable("resistor.i", "Current flowing from pin p to pin n [A]", 0.0, \
0.0,0.0,0.0,0,512)
DeclareAlias2("resistor.p.v", "Potential at the pin [V]", "resistor.v", 1, 5, 0,\
 4)
DeclareAlias2("resistor.p.i", "Current flowing into the pin [A]", "resistor.i", 1,\
 5, 1, 132)
DeclareVariable("resistor.n.v", "Potential at the pin [V]", 0, 0.0,0.0,0.0,0,521)
DeclareAlias2("resistor.n.i", "Current flowing into the pin [A]", "resistor.i", -1,\
 5, 1, 132)
...
0.0,0.0,0.0,0,560)
DeclareParameter("sineVoltage.freqHz", "Frequency of sine wave [Hz]", 5, 50, \
0.0,0.0,0.0,0,560)
...
DeclareAlias2("switch.p.v", "Potential at the pin [V]", "sineVoltage.v", 1, 5, 7,\
 4)
DeclareAlias2("switch.p.i", "Current flowing into the pin [A]", "resistor.i", 1,\
 5, 1, 132)
DeclareAlias2("switch.n.v", "Potential at the pin [V]", "resistor.v", 1, 5, 0, 4)
DeclareAlias2("switch.n.i", "Current flowing into the pin [A]", "resistor.i", -1,\
 5, 1, 132)
...
DeclareVariable("KattleWall.Q_flow", "Heat flow rate from port_a -> port_b [W]",\
 0.0, 0.0,0.0,0.0,0,512)
DeclareVariable("KattleWall.dT", "port_a.T - port_b.T [K,]", 0.0, 0.0,0.0,0.0,0,512)
DeclareAlias2("KattleWall.port_a.T", "Port temperature [K|degC]", "Water.T", 1, 1,\
 1, 4)
DeclareAlias2("KattleWall.port_a.Q_flow", "Heat flow rate (positive if flowing from outside into the component) [W]",\
 "KattleWall.Q_flow", 1, 5, 37, 132)
DeclareAlias2("KattleWall.port_b.T", "Port temperature [K|degC]", \
"roomTemperature.T", 1, 7, 14, 4)
DeclareAlias2("KattleWall.port_b.Q_flow", "Heat flow rate (positive if flowing from outside into the component) [W]",\
 "KattleWall.Q_flow", -1, 5, 37, 132)
DeclareParameter("KattleWall.G", "Constant thermal conductance of material [W/K]",\
